...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI2)
  {
    ...
    PB10     ------> SPI2_SCK
    */
    GPIO_InitStruct.Pin = EPD_DATA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(EPD_DATA_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = EPDA_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(EPDA_SCK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI2)
  {
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(EPD_DATA_GPIO_Port, EPD_DATA_Pin);

    HAL_GPIO_DeInit(EPDA_SCK_GPIO_Port, EPDA_SCK_Pin);
